...
export const TRACKS: Track[] = [
  {
    ...
    outcomes: [
      ...
      "팀원에게 자동화 워크플로를 도입하고 ROI를 측정할 수 있어요",
    ...
    highlights: [
      ...
      {
        title: "커스텀 capstone 프로젝트",
        description:
          "내 업무에서 가장 아픈 반복 작업을 골라 end-to-end 자동화를 완성합니다. 멘토 피드백으로 실제 사용 가능한 수준으로 다듬습니다.",
      },
      {
        title: "레벨에 맞는 진입점",
        description:
          "입문부터 어드밴스드까지 레벨별로 구성돼 있어, 내 지금 수준에서 바로 시작할 수 있습니다.",
      },
    ],
  },
  {
